...
export type ProjectItem = {
  ...
  href: string
  tag: ProjectTag
  /** When true, this project appears in home and experience scrolling tracks. */
  includeInScrollingTracks: boolean
}
...
export const scrollingTrackProjectItems = projectItems.filter(
  (item) => item.includeInScrollingTracks,
)
